...
# A.25 Prompt for hypothesis generation after literature review
def generation_hypothesis_after_literature(goal, preferences, source_hypothesis, instructions, articles_with_reasoning):
    prompt = f"""
...
# A.26 Prompt for hypothesis generation after scientific debate
def generation_hypothesis_after_debate(transcript, goal, idea_attributes, preferences, instructions, reviews_overview):
    prompt = f"""
